        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="proses_ubah_siswa.php" method="post">
                    ...
                    Nama Siswa :
                    <br><input type ="text" name ="nama siswa" value ="<?=$dt_siswa['nama_siswa']?>" class = "form-control"></br>
                    
                    Tanggal Lahir:
                    <br><input type ="date" name ="tanggal lahir" value ="<?=$dt_siswa['tanggal_lahir']?>" class = "form-control"></br>
                    ...
                    <select name="gender" class="form-control">
                        ...
                        ?>
                        <option value="<?=$key_gender?>"<?=$selec?>><?=$val_gender?></option>
                        <?php endforeach ?>
                    </select></br>
                    Alamat :
                    ...
                    <br>
                    <input type="submit" name="simpan" value="Ubah Siswa" class="btn btn-dark">
                    </br>
    </form>
