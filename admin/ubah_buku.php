        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="proses_ubah_buku.php" method="post" enctype="multipart/form-data">
                    ...
                    <br><img src="images/<?php echo $dt_buku['foto']; ?>" style="width: 120px;float: left;margin-bottom: 5px;"></br>
                    <br><br><br><br><br><br><input type="file" name="foto" /></br></br></br></br></br></br>
                    <i style="float: left;font-size: 11px;color: light">Abaikan jika tidak merubah gambar produk</i>
                    
                    <br><input type="submit" name="simpan" value="Ubah Buku" class="btn btn-dark">
                    </br>
    </form>
    </div>
    </div>
